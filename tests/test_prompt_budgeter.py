...
import pytest
from prompt_budgeter.models import FrontierPayload, ExecutionStatus
from prompt_budgeter.engine import FrontierDomainEngine
from prompt_budgeter.agents import TokenUsageProfilerAgent, ToolCallCompressorAgent, HeadroomPreserverAgent, PromptBudgetCoordinator
from prompt_budgeter.cli import main


def test_sub_agents():
    a1 = TokenUsageProfilerAgent()
...
def test_coordinator():
    ...
    assert "Token Economy & KV-Cache Management" in ans or "specifications" in ans
