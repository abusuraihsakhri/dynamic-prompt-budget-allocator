"""
Automated Pytest for dynamic-prompt-budget-allocator Enrichment Modules.
"""
import sys
...
from enrichment import (
    BudgetExhaustionPredictionEngine,
    PrioritybasedAllocationEngine,
    HistoricalBudgetAnalyticsEngine,
    DynamicModelDownscalingEngine,
    BudgetSharingAcrossAgentsEngine,
    DynamicpromptbudgetallocatorEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = DynamicpromptbudgetallocatorEnrichmentSuite()
