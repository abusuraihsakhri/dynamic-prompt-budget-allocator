"""
Data Models & Telemetry Definitions for PromptBudgeter: Dynamic Token Budgeting & Key-Value Cache Compressor.
...
class AgentTelemetryAlert:
    ...
    standard_reference: str = "Token Economy & KV-Cache Management"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
