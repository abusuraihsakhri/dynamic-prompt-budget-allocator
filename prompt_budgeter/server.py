"""
FastAPI REST API Server for PromptBudgeter: Dynamic Token Budgeting & Key-Value Cache Compressor.
"""
...
def create_app():
    try:
        ...
        app = FastAPI(
            title="PromptBudgeter: Dynamic Token Budgeting & Key-Value Cache Compressor",
            description="Calculates exact token consumption per system role, compresses verbose historical tool calls, and guarantees prompt headroom for generation.",
        ...
        @app.get("/health")
        def health():
            return {"status": "HEALTHY", "system": "dynamic-prompt-budget-allocator", "domain": "Autonomous Context Management & State Engines", "version": "2.0.0-FRONTIER"}
