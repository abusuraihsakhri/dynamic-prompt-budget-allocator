"""
FastAPI REST API Server for Dynamic Prompt Budget Allocator.
"""
...
app = FastAPI(
    title="Dynamic Prompt Budget Allocator API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "dynamic-prompt-budget-allocator", "domain": "Long-Horizon Agent Context & State Architecture", "standard": "Autonomous Agent State Machine & Token Economy RFC", "version": "3.0.0-ENTERPRISE"}
